...
class Setting extends Model {
  ...
  String distanceUnit;
  bool enableOtp;
  String subscriptionAmount,subscriptionType,subscriptionTypeId,subscriptionTime;
  ...
  Setting.fromJson(Map<String, dynamic> json) {
    ...
    subscriptionTypeId = json['subscription_type'];
    subscriptionTime = json['subscription_time'];
    subscriptionType = json['subscription_type']=="1"?"Day":json['subscription_type']=="2"?"Month":"Year";
    activeSubscription = boolFromJson(json, 'is_subscription_active');
