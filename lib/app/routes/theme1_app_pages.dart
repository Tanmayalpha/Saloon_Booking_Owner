...
import 'package:beauty_salons_owner/app/modules/add_salon/views/add_address.dart';
import 'package:beauty_salons_owner/app/modules/add_salon/views/add_amenities.dart';
import 'package:beauty_salons_owner/app/modules/add_salon/views/add_available.dart';
import 'package:beauty_salons_owner/app/modules/add_salon/views/add_bank.dart';
import 'package:beauty_salons_owner/app/modules/add_salon/views/add_service.dart';
import 'package:beauty_salons_owner/app/modules/insights/bindings/contact_binding.dart';
import 'package:beauty_salons_owner/app/modules/insights/bindings/insight_binding.dart';
import 'package:beauty_salons_owner/app/modules/insights/views/contact_us_view.dart';
import 'package:beauty_salons_owner/app/modules/insights/views/insight_view.dart';
import 'package:beauty_salons_owner/app/modules/insights/views/manage_seats_view.dart';
import 'package:beauty_salons_owner/app/modules/insights/views/my_query.dart';
import 'package:beauty_salons_owner/app/modules/insights/views/off_duty_view.dart';
import 'package:beauty_salons_owner/app/modules/insights/views/offer_view.dart';
import 'package:beauty_salons_owner/app/modules/seat_view/bindings/seat_binding.dart';
import 'package:beauty_salons_owner/app/modules/seat_view/views/seat_view.dart';
import 'package:get/get.dart';

import '../middlewares/auth_middleware.dart';
import '../middlewares/salon_owner_middleware.dart';
import '../modules/add_salon/bindings/add_binding.dart';
import '../modules/add_salon/views/add_salon.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.INSIGHT, page: () => InsightView(), binding: InsightBinding()),
    GetPage(name: Routes.SEAT, page: () => SeatView(), binding: SeatBinding()),
    GetPage(name: Routes.MANAGE_SEAT, page: () => ManageSeatsView(), binding: InsightBinding()),
    GetPage(name: Routes.CONTACT_US, page: () => ContactUsView(), binding: ContactBinding()),
    GetPage(name: Routes.QUERY, page: () => QueryView(), binding: ContactBinding()),
    GetPage(name: Routes.OFFERS, page: () => OfferView(), binding: InsightBinding()),
    GetPage(name: Routes.OFF_DUTY, page: () => OffDutyView(), binding: InsightBinding()),
    ...
    GetPage(name: Routes.SALON_ADD_FORM, page: () => AddSalonView(), binding: AddSalonBinding(), middlewares: [AuthMiddleware()]),
    GetPage(name: Routes.SALON_BANK_FORM, page: () => AddBankView(), binding: AddSalonBinding(), middlewares: [AuthMiddleware()]),
    GetPage(name: Routes.SALON_LINK_FORM, page: () => AddAmenities(), binding: AddSalonBinding(), middlewares: [AuthMiddleware()]),
    GetPage(name: Routes.SALON_ADDRESS_FORM, page: () => AddAddressView(), binding: AddSalonBinding(), middlewares: [AuthMiddleware()]),
    GetPage(name: Routes.SALON_SERVICE_FORM, page: () => AddServiceView(), binding: AddSalonBinding(), middlewares: [AuthMiddleware()]),
    GetPage(name: Routes.SALON_WORKING_FORM, page: () => AddAvailableView(), binding: AddSalonBinding(), middlewares: [AuthMiddleware()]),
