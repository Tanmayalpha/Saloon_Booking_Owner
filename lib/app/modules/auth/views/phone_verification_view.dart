                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 5),
                          Text(
                            "Welcome to the best salon service system!\n Your otp is ${controller.otp.value}".tr,
                      ...
                      BlockButtonWidget(
                        onPressed: () async {
                          if(controller.fromRegister){
                            if(controller.otp.value==controller.smsSent.value){
                               controller.register();
                            }else{
                              Get.showSnackbar(Ui.ErrorSnackBar(message: "Wrong OTP".toString()));
                            }

                          }else{
                            await controller.verifyLoginPhone();
                          }
