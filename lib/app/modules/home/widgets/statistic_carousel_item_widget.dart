...
class StatisticCarouselItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsetsDirectional.only(start: this.marginLeft, end: 20, top: 5, bottom: 5),
          ...
          if (statistic.description == "total_earning")
            Ui.getPrice(double.tryParse(statistic.value),
                style: Get.textTheme.headline2.merge(
                  TextStyle(height: 1,fontSize: 14.0),
                ),
              from: true
            )
          else
            Text(
              ...
              style: Get.textTheme.headline2.merge(TextStyle(height: 1,fontSize: 14.0)),
            ),
          SizedBox(height: 8),
          Text(
