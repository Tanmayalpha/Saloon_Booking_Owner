          ...
          builder: (BuildContext context) {
            return Hero(
              ...
              child: CachedNetworkImage(
                ...
                errorWidget: (context, url, error) => Icon(Icons.photo,size: 96,),
              ),
            );
          },
        );
                ...
                children: [
                  if (_eService.getOldPrice > 0)
                    Ui.getPrice(
                      ...
                      style: Get.textTheme.headline6.merge(TextStyle(color: Get.theme.focusColor, decoration: TextDecoration.lineThrough,fontSize: 12.0)),
                    ),
                  if (_eService.getOldPrice > 0)
                    SizedBox(width: 8,),
                  Ui.getPrice(
                    _eService.getPrice,
                    style: Get.textTheme.headline3.merge(TextStyle(color: Get.theme.colorScheme.secondary,fontSize: 14.0)),
                  ),
                ],
              ),
            ],
