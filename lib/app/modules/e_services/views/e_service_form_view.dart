...
class EServiceFormView extends GetView<EServiceFormController> {
            ...
            child: Column(
              ...
              children: [
               ...
               /* Obx(() {
                ...
                Get.isRegistered<RootController>()&&Get.find<RootController>().salons.first.salonType=="3"?Container(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          MaterialButton(
                            onPressed: () async {
                              ...
                              if(selectedValues!=null){
                                controller.eService.update((val) {
                                  val.gender = selectedValues.id;
                                  val.genderText = selectedValues.name;
                                });
                              }
                      ...
                      Obx(() {
                        if (controller.eService.value?.gender == null ??
                            true) {
                          return Padding(
                          ...
                          return buildGender(controller.eService.value);
                        }
                      })
                    ],
                  ),
                      ...
                      onTap: () async {
                        ...
                        if (time.isNotEmpty) {
                          ...
                          controller.eService.value.duration =
                              (durationToString(hours * 60 + minute))
                                  .toString();
                      ...
                      child: Text(
                        controller.eService.value.duration == "" ||
                            controller.eService.value.duration ==
                                null
                            ? "Duration*"
                            : controller.eService.value.duration.contains("m")?DateFormat('HH:mm').format(DateFormat("HH'h' mm'm'").parse(controller.eService.value.duration)):controller.eService.value.duration,
                        style: TextStyle(
                          fontSize: 10.0,
                        ),
                      ),
  ...
  Widget buildGender(EService _salon) {
    return Padding(
      padding: EdgeInsets.symmetric(vertical: 10),
      child: Container(
        padding: EdgeInsets.symmetric(vertical: 4),
        child: Text(_salon.genderText
