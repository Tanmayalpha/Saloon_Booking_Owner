  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      /*floatingActionButton: new FloatingActionButton(
        ...
        onPressed: () => {Get.toNamed(Routes.SALON_SERVICE_FORM)},
      ...
      appBar: AppBar(
        title: Text(
          Get.isRegistered<RootController>()&&Get.find<RootController>().salons.isNotEmpty?"My ${Get.find<RootController>().salons.first.salonCategory.title}":"My Salons".tr,
